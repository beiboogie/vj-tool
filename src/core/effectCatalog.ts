...
export const effectCatalog: EffectPreset[] = [
  ...
  { type: 'dynamicScatteredText', label: '动态散步文字 Dynamic', category: '文字', layer: 'text', config: { color: '$secondary', count: 15 } },
  ...
  { type: 'fallingText', label: '文字雨 Falling', category: '文字', layer: 'decoration', config: { color: '$accent', strokeColor: '$primary', count: 30 } },
  { type: 'bubbleText', label: '气泡文字 Bubble', category: '文字', layer: 'decoration', config: { color: '$accent', strokeColor: '$primary', count: 20 } },
