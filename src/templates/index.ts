...
import { dynamicBackgroundTemplate } from './dynamicBackground';
import { bubbleBackgroundTemplate } from './bubbleBackground';
...
export const templates: TemplateConfig[] = [
  ...
  treeTemplate,              // 16 树
  dynamicBackgroundTemplate, // 17 动态背景
  bubbleBackgroundTemplate,  // 18 气泡背景
];
